...
const DashboardPage = () => {
  ...
  return (
    <div className="w-full min-h-screen h-auto flex flex-col items-center justify-center p-8 pt-44">
      <div className="w-[70%] min-h-[90vh] h-auto rounded-md  p-4">
        ...
        <div className="w-full h-full p-4 flex flex-col gap-12">
